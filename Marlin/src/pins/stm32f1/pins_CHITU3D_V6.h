...
// not use									 PA4
//											 PA8
// USART1_TX								 PA9	// to CH340 USB
// USART1_RX								PA10	// to CH340 USB
// not use									PA11
// not use									PA13	// Z stop +		for connect ST LINK (JTMS-SWDIO) remove C28 and shortcut R30
// not use									PA14	// Z stop -		for connect ST LINK (JCK-SWCLK)  remove C34 and add wire detwen STM32(76) and Z stop(S)
// not use									 PB1
// not use									 PB2
//											 PB3	MAX6675 CLK
